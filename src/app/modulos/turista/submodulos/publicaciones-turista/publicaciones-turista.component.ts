...
@Component({
  selector: 'app-publicaciones-turista',
  templateUrl: './publicaciones-turista.component.html',
  styleUrls: ['./publicaciones-turista.component.css'],
  providers  : [UserService, PublicationService]
})
export class PublicacionesTuristaComponent implements OnInit {
	...
	constructor(
		...
		this.title     = 'Paquetes y Novedades';
