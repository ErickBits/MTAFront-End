...
@Component({
  selector: 'app-timeline-turista',
  templateUrl: './timeline-turista.component.html',
  styleUrls: ['./timeline-turista.component.css'],
  providers  : [UserService, PublicationService]
})
export class TimelineTuristaComponent implements OnInit {
