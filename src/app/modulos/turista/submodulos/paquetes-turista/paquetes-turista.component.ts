...
@Component({
  selector: 'app-paquetes-turista',
  templateUrl: './paquetes-turista.component.html',
  styleUrls: ['./paquetes-turista.component.css']
})
export class PaquetesTuristaComponent implements OnInit {
