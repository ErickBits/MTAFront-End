...
@Component({
  selector: 'app-fichados-turista',
  templateUrl: './fichados-turista.component.html',
  styleUrls: ['./fichados-turista.component.css']
})
export class FichadosTuristaComponent implements OnInit {
