...
@Component({
  selector: 'app-sidebar-turista',
  templateUrl: './sidebar-turista.component.html',
  styleUrls: ['./sidebar-turista.component.css']
})
export class SidebarTuristaComponent implements OnInit {
