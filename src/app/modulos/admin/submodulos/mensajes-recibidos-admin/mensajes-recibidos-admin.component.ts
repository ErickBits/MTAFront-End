...
@Component({
  selector: 'app-mensajes-recibidos-admin',
  templateUrl: './mensajes-recibidos-admin.component.html',
  styleUrls: ['./mensajes-recibidos-admin.component.css']
})
export class MensajesRecibidosAdminComponent implements OnInit {
