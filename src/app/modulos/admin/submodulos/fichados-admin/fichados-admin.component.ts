...
@Component({
  selector: 'app-fichados-admin',
  templateUrl: './fichados-admin.component.html',
  styleUrls: ['./fichados-admin.component.css']
})
export class FichadosAdminComponent implements OnInit {
