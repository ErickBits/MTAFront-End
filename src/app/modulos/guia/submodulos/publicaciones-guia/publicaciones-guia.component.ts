...
@Component({
  selector: 'app-publicaciones-guia',
  templateUrl: './publicaciones-guia.component.html',
  styleUrls: ['./publicaciones-guia.component.css'],
  providers  : [UserService, PublicationService]
})
export class PublicacionesGuiaComponent implements OnInit {
