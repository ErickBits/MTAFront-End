...
@Component({
  selector: 'app-interesados-guia',
  templateUrl: './interesados-guia.component.html',
  styleUrls: ['./interesados-guia.component.css']
})
export class InteresadosGuiaComponent implements OnInit {
