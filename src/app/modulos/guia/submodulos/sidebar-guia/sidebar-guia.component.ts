...
@Component({
  selector: 'app-sidebar-guia',
  templateUrl: './sidebar-guia.component.html',
  styleUrls: ['./sidebar-guia.component.css']
})
export class SidebarGuiaComponent implements OnInit {
