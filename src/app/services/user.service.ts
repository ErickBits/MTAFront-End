...
export class UserService {
	...
	/** Método para REGISTRAR un guia **/
	registerGuia(user_to_register:User): Observable<any>{
		let params = JSON.stringify(user_to_register);
		let headers = new HttpHeaders().set('Content-Type', 'application/json');

		return this._http.post(this.url+'registerGuia', params, {headers:headers});
	}

	/** Método para REGISTRAR un turista **/
	registerTurista(user_to_register:User): Observable<any>{
		let params = JSON.stringify(user_to_register);
		let headers = new HttpHeaders().set('Content-Type', 'application/json');

		return this._http.post(this.url+'registerTurista', params, {headers:headers});
	}
